...
public class VBOInterleaved implements ShaderSource {
  ...
  //instanced VBO
  final static short INSTANCE_NBR_COMP    =  VEC4_CMP * 3; //position, normal/direction of the instance
  ...
  public void draw(PGraphics context) {
    ...
    //fill data is not necessary when you use compute shader because data are already bind
